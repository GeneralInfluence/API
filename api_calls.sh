...
# Initialize
curl -X POST -H "Content-Type: application/json" -d '{"models":["untrustworthy"]}' "http://0.0.0.0:9999/v1/gizmoduck/initialize/?app_id=SYNAPSIFY&app_key=908cecfa-9944-4e67-a05a-f9c200a9533e"
